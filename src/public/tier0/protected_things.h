...
// one day AND work on features too!
	...
	//#if defined( recvfrom )								// (torbensko)
	//	#undef recvfrom										// (torbensko)
	//#endif												// (torbensko)
	//#define recvfrom			recvfrom__USE_VCR_MODE		// (torbensko)
	...
	//	#undef EnterCriticalSection										// (torbensko)
	//#endif															// (torbensko)
	//#define EnterCriticalSection EnterCriticalSection__USE_VCR_MODE	// (torbensko)
